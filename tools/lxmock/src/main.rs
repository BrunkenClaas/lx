...
fn version_string() -> String {
    lx_core::version::build_version_string("lxmock", env!("CARGO_PKG_VERSION"))
}

#[derive(Parser)]
#[command(
    name = "lxmock",
    about = "Generate realistic mock/fixture data from a plain-English description",
    disable_version_flag = true
)]
struct Cli {
    /// Description of the data to generate (reads from stdin if omitted)
